...
def create_database():
    ...
    print(("=")*121)
    mydb = mysql.connector.connect(host="localhost", user="root",password="123456",database="stock")
    mycursor = mydb.cursor()
...
def sale_product():
    ...
    if cnt != 0 :
        ...
        mycursor.execute(sql, val)
        for x in mycursor:
            print("\t\t\t\tDETAILS OF PRODUCT WITH PRODUCT CODE",pcode,"ARE AS FOLLOWS-->")
            print(("=")*121)
            print(("-")*121)
...
while True:
    ...
    print("\t\t\t\t==============================================================")
    print("\t\t\t\t|  1.| PRODUCT DETAILS MANAGEMENT                            |")#IT REFERS TO DETAILS OF PRODUCT WE ARE CURRENTLY HAVING.
    print("\t\t\t\t==============================================================")
    print("\t\t\t\t|  2.| PRODUCT PURCHASE MANAGEMENT                           |")# IT REFERS TO DETAILS OF TRANSACTIONS DONE TO PURCHASE PRODUCTS DROM COMPANY.
    print("\t\t\t\t==============================================================")
    print("\t\t\t\t|  3.| PRODUCT SALES MANAGEMENT                              |")# IT REFERS TO DETAILS OF TRANSACTIONS IN WHICH PRODUCTS ARE SOLD TO CONSUMERS.
    print("\t\t\t\t==============================================================")
    print("\t\t\t\t|  4.| EMPLOYEE USER MANAGEMENT                              |")# IT REFERS TO THE MEMBERS OF THE INVENTORY
    print("\t\t\t\t==============================================================")
    print("\t\t\t\t|  5.| DATABASE ADMINISTRATION                               |")# IT REFERS TO THE MAIN FUNCTIONING DATABASE IN WHICH ALL DETAILS ARE STORED.
    print("\t\t\t\t==============================================================")
    print("\t\t\t\t|  6.| EXIT                                                  |")
    print("\t\t\t\t==============================================================")
    print(("=")*121)
    ...
    if n == 6:
        ...
        print('\n'*2)
        print(" \t\t                            CBSE BOARD 2019-20 COMPUTER SCIENCE PROJECT")
        print('\n'*2)
        print(" \t\t                                     SUPERVISED BY-")
